...
public class NonLoopingStateMachine {
    ...
    public static enum states{EMPTY,TEN,TWENTY,THIRTY,FORTY,FIFTY,SIXTY,SEVENTY,EIGHTY,NINETY,EXCESS}
    ...
    public static void generateTour(){
        ...
        while(!tour.isEmpty()){
            ...
            else if(p.currentState==states.EXCESS){
...
//            transitions.add(new Transition(nextInput,out));
    ...
    public static void main(String[] args){
        NonLoopingStateMachine.generateTour();
    }
}
